...
describe Fizzbuzz do
  ...
  context 'Github  number' do
    it { subject.calculate(17).should eq 'fizzbuzz' }
    it { subject.calculate(27).should eq 'fizzbuzz' }
    it { subject.calculate(75).should eq 'fizzbuzz' }
    it { subject.calculate(77).should eq 'fizzbuzz' }
  end
end
